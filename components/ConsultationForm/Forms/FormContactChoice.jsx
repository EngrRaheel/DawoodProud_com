...
import ContactViaSelect from '../SelectMui/MultiselectContact'
    ...
    return (
        <div className='flex flex-col justify-center items-center mx-w-[600px] mx-auto space-y-2'>
            <div className='flex flex-col justify-between items-center gap-8 md:gap-14'>
                ...
                <h2 className='text-[16px] md:text-[20px] font-medium text-center '>How would you like us to contact you?</h2>
            </div>
