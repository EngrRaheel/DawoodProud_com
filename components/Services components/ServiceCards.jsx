    ...
    return (
        <div className="flex flex-col  bg-contain bg-center bg-[url('/Images/blob_bg_2.png')] gap-12 ">
            ...
            <ServiceCard heading={"Certified YouTube Consultant"}
                ...
                btntext={`Let${"'"}s get started`} link={"/youtube-consultation"} />
            ...
            <ServiceCard heading={"YouTube SEO"}
                ...
                btntext={"Dominate YouTube Search Now"} bgColor={""} link={"/youtube-seo"} />
            ...
            <ServiceCard heading={"YouTube Keywords Research"}
                ...
                btntext={"Elevate your YouTube Game"} bgColor={""} link={"/youtube-keyword-research"} />
            ...
            <ServiceCard heading={"YouTube Automation"}
                ...
                btntext={"Get started today"} bgColor={""} link={"/youtube-automation"} />
            ...
            <ServiceCard heading={"YouTube Monetization"}
                ...
                btntext={"Skyrocket Your Profits Today"} bgColor={""} link={"/youtube-monetization"} />
            ...
            <ServiceCard heading={"YouTube Promotion "}
                ...
                btntext={"Promote your Channel Now"} bgColor={""} link={"/youtube-promotion-ads"} />
            ...
            <ServiceCard heading={" Overall YouTube Channel Management"}
                ...
                btntext={"Let us Help us Grow"} bgColor={""} link={"/youtube-channel-managment"} />
