            ...
            <div className="w-full   bg-cover bg-center  bg-[url('/Images/main-bg1.jpg')]  h-[30vh] md:h-[55vh]">
                ...
                <div className=' max-w-[1172px] mx-auto'>
                    <div className='flex flex-col justify-start items-start space-y-2 py-4 ml-[8%] md:ml-[10%] lg:ml-[12%]'>
                        <h1 className=' text-[60px] md:text-[65px] lg:text-[70px] font-normal font-inter '>
                            Join the Team
                        ...
                        <h2 className='text-[20px]'>First do it, then do it right, then do it better.</h2>
                    </div>
            ...
            <div className='w-full flex flex-col justify-center items-start max-w-[1172px] mx-auto '>
                ...
                <div className='flex flex-col justify-center items-center text-[#333333] font-Inter max-w-[900px] gap-2 mx-auto ml-[0%] md:ml-[10%] lg:ml-[12%]'>
                    <div className='flex flex-col justify-center items-start gap-3 w-full self-start p-5'>
                        <h2 className='font-semibold text-[44px] md:text-[44px]'>Why Work at Dawood Proud Agency?</h2>
                        <p className='font-normal text-[14px] md:text-[16px] font-Inter'>Our Motto is &quot;Stand Out from the Crowd&quot;. That&#39;s why we offer our Employees much more than just a job —
                            <br />
                            <br />
                ...
                <div className='mx-auto flex flex-col justify-start items-start gap-12 mb-20  md:ml-[10%] lg:ml-[15%] max-w-[900px] p-3 '>
                    ...
                    {jobsClosed.map((data, index) => {
                        return (
                            <div className='border-1 border-solid border-[black] grid grid-cols-[2fr_1fr] justify-between items-center px-3 md:px-3 py-3 md:py-6 shadow-md'key={index} >
                                <div className='flex flex-col '>
