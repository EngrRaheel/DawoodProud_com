                    ...
                    <div className='flex flex-col md:flex-row justify-center md:justify-between md:items-center'>
                        ...
                        <div className='w-full flex-1 '>
                            <div className='px-[5%] md:pl-[15%] md:pr-[7%] space-y-4 md:space-y-4  flex flex-col justify-center !items-center md:items-start'>
                                <h3 class="font-extrabold text-[24px] md:text-[30px] lg:text-[32px] text-center md:text-left">{heading2}</h3>
                                <p className='text-[#BCBCBC] font-normal text-[16px] md:text-[17px] lg:text-[18px] text-center md:text-left'>{para}</p>

                                <button className='flex justify-center items-center self-center md:self-start  font-bold px-2 sm:px-4  py-2 sm:py-3 gap-1  sm:gap-2 rounded-full text-xs sm:text-base bg-[#139DFF] hover:bg-[#3b82f6]'>
