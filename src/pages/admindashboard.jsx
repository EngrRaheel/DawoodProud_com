...
function Dashboard() {
    ...
    return (
        <div>
            {isLoggedIn ? (
                <div>
                    <AdminDashboard onclick={handleLogout} />

                </div>
            ) : (
                <div className="min-h-screen bg-[url('/Images/main-bg1.jpg')] ">
                    ...
                    <div className="flex flex-col justify-center items-center space-y-6 h-screen">
                        ...
                        <div className="grid grid-cols-1 w-full px-6 py-4 bg-white shadow-md sm:max-w-md sm:rounded-lg mx-auto">
                            <form onSubmit={handleLogin}>
                                ...
                                <button type="submit" onSubmit={handleLogin} className="w-full">Login</button>
                            </form>
                        </div>
                    </div>
                </div>
