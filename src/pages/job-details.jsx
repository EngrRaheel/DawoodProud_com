                ...
                <div className='flex flex-col justify-center items-center text-[black] font-Inter gap-4 w-full max-w-[1172px] mx-auto p-4 '>
                    ...
                    <div className='flex flex-col gap-2 ml-[8%] md:ml-[6%] lg:ml-[6%]'>
                        ...
                        <ul className='font-normal text-[12px] md:text-[18px] flex flex-col gap-3 list-disc p-4'>
                            ...
                            <li>Applicants should have at least <li>5 years</li> of <strong>active internet usage</strong>experience. We&#39;re looking for <strong>Gen-Z</strong> employees with a strong command over the internet.</li>
