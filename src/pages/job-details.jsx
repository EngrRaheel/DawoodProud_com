    ...
    return (
        <div className='w-full min-h-screen font-Inter text-white bg-white h-full'>
            ...
            <div className='w-full flex flex-col justify-center items-start max-w-[1172px] space-y-10 mb-8 mx-auto '>
                ...
                <div className='flex flex-col justify-center items-center text-[black] font-Inter gap-4 w-full max-w-[1172px] mx-auto p-4 '>
                    <div className='flex flex-col gap-2 ml-[8%] md:ml-[6%] lg:ml-[6%]'>
                        ...
                        <h2 className='font-semibold text-[24px] md:text-[28px]'>About Us</h2>
                    ...
                    <div className='flex flex-col gap-2 ml-[8%] md:ml-[6%] lg:ml-[6%]'>
                        <h3 className='font-semibold text-[24px] md:text-[32px]'> Why Join Us?</h3>
                        <p className='font-normal text-[14px] md:text-[20px]'>
                        ...
                        <h3 className='font-semibold text-[24px] md:text-[28px] '> What you will be doing:</h3>
                        <ul className='font-normal text-[14px] md:text-[20px] flex flex-col gap-3 list-disc p-4'>
                        ...
                        <h3 className='font-semibold text-[24px] md:text-[28px]'> Who you are</h3>
                        <ul className='font-normal text-[14px] md:text-[20px] flex flex-col gap-3 list-disc p-4'>
