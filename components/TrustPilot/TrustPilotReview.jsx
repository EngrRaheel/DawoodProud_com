...
function TrustPilotReview() {
    return (
        <div className="w-full min-h-[80vh] flex items-center justify-center flex-col  text-white bg-testing gap-6 p-6  ">
            <div className=' w-full flex flex-col justify-center items-center space-y-2 '>
                <div className='w-[200px] h-[99px] relative'>
                    <Image src={"/Images/trustpilot.webp"} alt={'image for the truts pilot'} fill></Image>
                </div>
                <p className='flex flex-col justify-center items-center text-white hover:text-[#F5812A] text-base' >5.0 reviews on Trustpilot</p>
            </div>
            <div className='  w-[90vw] md:w-[80vw] lg:w-[70vw] flex flex-col justify-center items-center text-white gap-12'>
                <h2 className='xs:text-[30px] md:text-[40px] lg:text-[44px] font-semibold leadiing-[30px] text-[#F5812A] text-center'>What Our Clients Are Saying</h2>
                <div className='flex flex-col justify-center items-center bg-[#eee] w-full gap-4 p-5 rounded-lg box-border '>
                    ...
                    <div className='w-full flex flex-col justify-start items-center gap-8 overflow-y-scroll p-4 h-[266px] '>
                        <div className=' bg-[#f7f7f7] flex flex-col justify-center items-start text-[black] p-5 space-y-2 '>
                            ...
                            <p>{`"Excellent Ranking against Multiple Keywords. 12th project with Dawood.
                        ...
                        <div className=' bg-[#f7f7f7] flex flex-col justify-center items-start text-[black] p-5 space-y-2 '>
                            ...
                            <p>{`"Dawood is very thorough in his work and a valuable asset for any entrepreneur.
                        ...
                        <div className=' bg-[#f7f7f7] flex flex-col justify-center items-start text-[black] p-5 space-y-2 '>
                            ...
                            <p>{`"Thank you for your service. My YouTube video has ranked. And I got a lot of views and subscribers.
                        ...
                        <div className=' bg-[#f7f7f7] flex flex-col justify-center items-start text-[black] p-5 space-y-2 '>
                            ...
                            <p>{`"Amazing work I am very pleased with the results. The content strategy make sense and are on-point with what he and I initially discussed.
