...
import RevSelect from './RevenueSelect'
    ...
    return (
        <div className='flex flex-col justify-center items-center mx-w-[600px] mx-auto gap-3'>
            <div className='flex flex-col justify-between items-center gap-8 '>
                <h1 className='text-[18px] sm:text-[20px] md:text-[24px] text-center font-bold'>Thank you for Showing Interest in Dawood Proud Services <br /> to take your YouTube Channel to New Heights</h1>
                <h2 className='text-[18px] sm:text-[20px] md:text-[24px] font-semibold text-center text-[#139dff]'>Nice to meet you😊</h2>
                <h2 className='text-[18px] sm:text-[20px] md:text-[24px] font-semibold text-center '>What is your Average Monthly YouTube Channel revenue?</h2>
            </div>
