            ...
            <div className='w-full flex flex-col justify-center items-start max-w-[1172px] space-y-10 mb-8 mx-auto '>
                ...
                <div className='flex flex-col justify-center items-center text-[black] font-Inter space-y-8 w-full max-w-[1172px] mx-auto p-4 '>
                    ...
                    <div className='flex flex-col gap-1 ml-[8%] md:ml-[6%] lg:ml-[6%] space-y-4 '>
                        <div>
                            <h1 className='font-medium text-[22px] md:text-[28px] mb-4'>Key Features</h1>
                            <ul className='font-normal text-[12px] md:text-[16px]  list-disc px-4'>
                                ...
                                <li><strong>No Previous Work Experience</strong> is Required</li>
                            </ul>
                        </div>
                        <div>
                            <h3 className='font-medium text-[22px] md:text-[28px] mb-4'> Basic Job Requirements:</h3>
                            <ul className='font-normal text-[12px] md:text-[16px]  list-disc px-4'>
                        ...
                        <div>
                            <h2 className='font-medium text-[22px] md:text-[28px] mb-4'>Why Join Us?</h2>
                            ...
                            <ul className='font-normal text-[12px] md:text-[16px]  list-disc p-4'>
                            ...
                            <p className="font-normal text-[12px] md:text-[16px] list-disc p-1">We understand that a happy and satisfied employee is the key to Happy Clients. That&#39;s why we go the extra mile to create a supportive environment where you can thrive. Joining our team means not just a job, but an experience of a lifetime. We appreciate our CEO, Dawood, for his beautiful services and for creating an atmosphere where every team member is valued and respected. So, apply now without any worries, and let us take care of your career growth!</p>
                        </div>



                        <div>
                            <h2 className="font-medium text-[22px] md:text-[28px] mb-4">The ideal candidate is expected to:</h2>
                            <ul className='font-normal text-[12px] md:text-[16px]  list-disc p-4'>
                        ...
                        <div>
                            <h3 className='font-medium text-[22px] md:text-[28px] mb-4'>What you will be doing:</h3>
                            <p className='font-normal text-[12px] md:text-[16px]'>At our Organization, you will be trained you as “YouTube Content Strategist”. After getting proper training, You will be responsible to:</p>
                            <ul className='font-normal text-[12px] md:text-[16px]  list-disc p-4'>
                            ...
                            <p className="font-normal text-[12px] md:text-[16px] list-disc p-1">
                        ...
                        <div>
                            <h3 className='font-medium text-[22px] md:text-[28px] mb-4'>Selection Process</h3>
                            <p className='font-normal text-[12px] md:text-[16px]'>We take our recruitment process seriously to ensure that we hire the best fit for our team. Here&#39;s what you can expect from the selection process:</p>
                            <ul className='font-normal text-[12px] md:text-[16px] list-disc p-4'>
