    ...
    return (
        <div className={`w-full min-h-[100vh] font-Inter text-white relative ${bgColor}`}>
            <div className="w-full min-h-[100vh] p-2 ">
                <div className="w-full max-w-[1172px]  flex flex-col items-center justify-center mx-auto space-y-6 md:space-y-14  ">
                    ...
                    <div className='flex flex-col md:flex-row justify-between item'>
                        ...
                        <div className='w-full flex-1 '>
                            <div className='px-[8%] md:pl-[15%] md:pr-[7%] space-y-6 md:space-y-6 text-center md:text-left flex flex-col justify-center items-start'>
                                <h2 class="font-extrabold text-[24px] md:text-[30px] lg:text-[32px] leading-[38px]">{heading2}</h2>
                                <p className='text-[#BCBCBC] font-normal  text-[16px] md:text-[17px] lg:text-[18px] text-start'>{para}</p>

                                <button className='flex justify-center items-center self-center md:self-start text-base font-bold px-4 py-3 rounded-full !mt-8 gap-2 bg-[#139DFF] hover:bg-[#3b82f6]'>
