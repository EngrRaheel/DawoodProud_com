        ...
        <div className='flex flex-col mx-auto font-Inter text-white rounded-2xl  px-[3px] md:px-[6px] pb-4 pt-8 bg_testimonials'>
            ...
            <div className='flex flex-col items-center space-y-3'>
                <div className='w-[80px] h-[80px] rounded-full  relative mx-auto overflow-hidden' >
                    <Image src={url} className='object-fill ' fill alt='cardimage' />
                </div>
            ...
            <div class="flex justify-center items-center gap-3 mt-4">
                <div class="flex-1 flex flex-col items-center font-medium space-y-5">
                    <div class="font-bold text-testimonial-card-stat-sm md:text-testimonial-card-stat-md lg:text-testimonial-card-stat-lg">{subs}</div>
                ...
                <div class="flex-1 flex flex-col items-center font-medium space-y-5">
                    <div class="font-bold text-testimonial-card-stat-sm md:text-testimonial-card-stat-md lg:text-testimonial-card-stat-lg">{views}</div>
                    <div class="text-base flex items-center text-white opacity-75">
            ...
            {/* Group thrid itmes */}
            <div className='flex flex-col flex-1 gap-2 h-full overflow-y-auto font-bold text-testimonial-card-quote-sm md:text-testimonial-card-quote-md lg:text-testimonial-card-quote-lg mt-6 space-y-2 '>
                <div className='font-bold leading-6 text-xl overflow-auto justify-center items-center'> {para}</div>
                <Link href="/ProofOfwork" >
                    <button className='flex justify-center items-center mx-auto px-2 md:px-4 py-3 gap-1 rounded-full  drop-shadow-lg  bg-[#139dff] hover:bg-[#3b82f6] duration-200 ' >
